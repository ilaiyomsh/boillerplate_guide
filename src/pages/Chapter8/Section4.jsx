...
const Section4 = () => {
  return (
    <GuideSection 
      title="סעיף 8.4: כותרת הסעיף ה-4"
      nextPath="/"
      nextTitle="בית"
      prevPath="/chapter8/section3"
      prevTitle="סעיף 8.3"
      chapterNumber={8}
      sectionNumber={4}
    >
      <p>
        זהו הסעיף ה-4 בפרק ה-8. כאן תוכלו למצוא הסבר מפורט על הנושא.
      </p>
...
function exampleFunction() {
  console.log('זוהי דוגמה לפרק 8, סעיף 4');
