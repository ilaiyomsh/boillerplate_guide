...
const Section3 = () => {
  return (
    <GuideSection 
      title="סעיף 2.3: כותרת הסעיף ה-3"
      nextPath="/chapter2/section4"
      nextTitle="סעיף 2.4"
      prevPath="/chapter2/section2"
      prevTitle="סעיף 2.2"
      chapterNumber={2}
      sectionNumber={3}
    >
      <p>
        זהו הסעיף ה-3 בפרק ה-2. כאן תוכלו למצוא הסבר מפורט על הנושא.
      </p>
...
function exampleFunction() {
  console.log('זוהי דוגמה לפרק 2, סעיף 3');
