...
const Section4 = () => {
  return (
    <GuideSection 
      title="סעיף 2.4: כותרת הסעיף ה-4"
      nextPath="/chapter3"
      nextTitle="פרק 3"
      prevPath="/chapter2/section3"
      prevTitle="סעיף 2.3"
      chapterNumber={2}
      sectionNumber={4}
    >
      <p>
        זהו הסעיף ה-4 בפרק ה-2. כאן תוכלו למצוא הסבר מפורט על הנושא.
      </p>
...
function exampleFunction() {
  console.log('זוהי דוגמה לפרק 2, סעיף 4');
