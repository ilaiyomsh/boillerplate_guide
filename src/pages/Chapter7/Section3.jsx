...
const Section3 = () => {
  return (
    <GuideSection 
      title="סעיף 7.3: כותרת הסעיף ה-3"
      nextPath="/chapter7/section4"
      nextTitle="סעיף 7.4"
      prevPath="/chapter7/section2"
      prevTitle="סעיף 7.2"
      chapterNumber={7}
      sectionNumber={3}
    >
      <p>
        זהו הסעיף ה-3 בפרק ה-7. כאן תוכלו למצוא הסבר מפורט על הנושא.
      </p>
...
function exampleFunction() {
  console.log('זוהי דוגמה לפרק 7, סעיף 3');
