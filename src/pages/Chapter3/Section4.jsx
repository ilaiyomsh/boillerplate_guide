...
const Section4 = () => {
  return (
    <GuideSection 
      title="סעיף 3.4: כותרת הסעיף ה-4"
      nextPath="/chapter4"
      nextTitle="פרק 4"
      prevPath="/chapter3/section3"
      prevTitle="סעיף 3.3"
      chapterNumber={3}
      sectionNumber={4}
    >
      <p>
        זהו הסעיף ה-4 בפרק ה-3. כאן תוכלו למצוא הסבר מפורט על הנושא.
      </p>
...
function exampleFunction() {
  console.log('זוהי דוגמה לפרק 3, סעיף 4');
