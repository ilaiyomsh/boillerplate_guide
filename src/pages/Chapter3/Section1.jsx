...
const Section1 = () => {
  return (
    <GuideSection 
      title="סעיף 3.1: כותרת הסעיף ה-1"
      nextPath="/chapter3/section2"
      nextTitle="סעיף 3.2"
      prevPath="/chapter3"
      prevTitle="פרק 3"
      chapterNumber={3}
    ...
    >
      <p>
        זהו הסעיף ה-1 בפרק ה-3. כאן תוכלו למצוא הסבר מפורט על הנושא.
      </p>
...
function exampleFunction() {
  console.log('זוהי דוגמה לפרק 3, סעיף 1');
