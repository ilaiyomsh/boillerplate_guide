...
const Section4 = () => {
  return (
    <GuideSection 
      title="סעיף 4.4: כותרת הסעיף ה-4"
      nextPath="/chapter5"
      nextTitle="פרק 5"
      prevPath="/chapter4/section3"
      prevTitle="סעיף 4.3"
      chapterNumber={4}
      sectionNumber={4}
    >
      <p>
        זהו הסעיף ה-4 בפרק ה-4. כאן תוכלו למצוא הסבר מפורט על הנושא.
      </p>
...
function exampleFunction() {
  console.log('זוהי דוגמה לפרק 4, סעיף 4');
