...
const Section2 = () => {
  return (
    <GuideSection 
      title="סעיף 4.2: כותרת הסעיף ה-2"
      nextPath="/chapter4/section3"
      nextTitle="סעיף 4.3"
      prevPath="/chapter4/section1"
      prevTitle="סעיף 4.1"
      chapterNumber={4}
      sectionNumber={2}
    >
      <p>
        זהו הסעיף ה-2 בפרק ה-4. כאן תוכלו למצוא הסבר מפורט על הנושא.
      </p>
...
function exampleFunction() {
  console.log('זוהי דוגמה לפרק 4, סעיף 2');
