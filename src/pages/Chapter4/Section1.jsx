...
const Section1 = () => {
  return (
    <GuideSection 
      title="סעיף 4.1: כותרת הסעיף ה-1"
      nextPath="/chapter4/section2"
      nextTitle="סעיף 4.2"
      prevPath="/chapter4"
      prevTitle="פרק 4"
      chapterNumber={4}
    ...
    >
      <p>
        זהו הסעיף ה-1 בפרק ה-4. כאן תוכלו למצוא הסבר מפורט על הנושא.
      </p>
...
function exampleFunction() {
  console.log('זוהי דוגמה לפרק 4, סעיף 1');
