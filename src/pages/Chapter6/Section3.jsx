...
const Section3 = () => {
  return (
    <GuideSection 
      title="סעיף 6.3: כותרת הסעיף ה-3"
      nextPath="/chapter6/section4"
      nextTitle="סעיף 6.4"
      prevPath="/chapter6/section2"
      prevTitle="סעיף 6.2"
      chapterNumber={6}
      sectionNumber={3}
    >
      <p>
        זהו הסעיף ה-3 בפרק ה-6. כאן תוכלו למצוא הסבר מפורט על הנושא.
      </p>
...
function exampleFunction() {
  console.log('זוהי דוגמה לפרק 6, סעיף 3');
