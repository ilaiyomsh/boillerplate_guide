...
const Section2 = () => {
  return (
    <GuideSection 
      title="סעיף 5.2: כותרת הסעיף ה-2"
      nextPath="/chapter5/section3"
      nextTitle="סעיף 5.3"
      prevPath="/chapter5/section1"
      prevTitle="סעיף 5.1"
      chapterNumber={5}
      sectionNumber={2}
    >
      <p>
        זהו הסעיף ה-2 בפרק ה-5. כאן תוכלו למצוא הסבר מפורט על הנושא.
      </p>
...
function exampleFunction() {
  console.log('זוהי דוגמה לפרק 5, סעיף 2');
